<script lang="ts">
    ...
    import { data, type DoomWad } from "../doom";
...
{#if wad}
<MusicPlayer audioRoot={musicGain} lump={wad.optionalLump('D_DM2TTL') ?? wad.optionalLump('D_INTRO')} {wad}  />
{/if}
